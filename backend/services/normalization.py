...
SKILL_RULES: tuple[SkillRule, ...] = (
    ...
    SkillRule("Web Development", (r"\bweb(?:site)?\s+(?:application\s+)?develop(?:ment)?\b", r"\bwebsite\b", r"\bweb\s+application\b")),
    SkillRule("Database Management", (r"\bdatabase\s+(?:manage|management|handling)\b", r"\bmanage\s+(?:a\s+)?database\b")),
